...
/*
        public function filterVComComposite(){
            //FILTRA OS VCOM COMPOSITES 
            return array(
  ...
  */      
       ...
       public function accessRules()
        {
            return array(
                //AUTORIZA ACESSO A USUÁRIOS AUTENTICADOS
                array('allow',
                    'actions'=>array('admin','create', 'edit','delete','list','show','update','view'),
                    'users'=>array('@'),
                ),                
                //SOMENTE O ADMINISTRADOR PODE DELETAR UM USUÁRIO.
                array('allow',
                    'actions'=>array('delete'),
                    'controllers'=>array('user'),
                    'users'=>array('root'),
                ),                //BLOQUEIA A DELEÇÃO/CRIAÇÃO DE USUÁRIOS POR OUTROS USUÁRIOS
                array('deny',
                    'actions'=>array('delete','create'),
                    'controllers'=>array('user'),
                    'users'=>array('*'),
                ),
                //BLOQUEIA O ACESSO AS FUNCIONALIDADES DE QUEM NÃO ESTÁ LOGADO
                array('deny',
                    'actions'=>array('create', 'edit','delete','list','show','update','view'),
                    'users'=>array('?'),
                ),                
            );
        }
