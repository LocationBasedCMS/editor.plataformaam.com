	...
	<?php echo $form->errorSummary($model); ?>
        <div class="row-fluid">
            ...
            <div class="span6">
                ...
                $centerLatitude = ($model->__get('startLatitude') + $model->__get('stopLatitude') )/2 ;
                $centerLongitude = ( $model->__get('startLongitude') + $model->__get('stopLongitude'))/2 ;
                $gMap->setCenter($centerLatitude ,$centerLongitude );
                ...
                $markerStartCoord = new EGMapMarker(
                        ...
                        array('title' => '(Start) Canto  Inferior Esquerdo','draggable'=>true),
                        'markerStartCoord',
